...
|---|---|---|
| `analysis/` | dataset ledger, fitted coefficients and statistics, feasibility map, figures, tables, the number summary behind the manuscript's results, and the full audit trail (`analysis/README.md`) | regenerated by the runner's analysis stage after every completed list, or with `python3 run_remote_share.py --analyse` |
